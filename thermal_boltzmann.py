...
state.state_space[int(size/2)-5:int(size/2)+5, int(size/2)-5:int(size/2)+5] = state.linearized_distribution(density, vx, vy, t)
state.state_space[int(size/2)-25:int(size/2)-15, int(size/2)-5:int(size/2)+5] = state.linearized_distribution(density, vx, vy, t)
state.plot_moment_0()
